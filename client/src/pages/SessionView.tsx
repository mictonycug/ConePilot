    ...
    return (
        <div className="flex-1 bg-background flex flex-col min-h-0">
            ...
            <div className="flex-1 flex flex-col lg:flex-row overflow-hidden min-h-0">
                ...
                <div className="lg:w-80 bg-white border-t lg:border-t-0 lg:border-l border-border p-4 lg:p-6 flex flex-col gap-4 lg:gap-6 flex-shrink-0 overflow-y-auto">
                    {/* Desktop Session Name */}
                    <div className="hidden lg:block">
                        <h2 className="text-xl font-bold text-text-primary mb-1">{currentSession.name}</h2>
                        <div className="flex items-center gap-2 text-sm text-text-secondary">
                            <span className="text-lg">{currentSession.cones.length}</span> cones on field

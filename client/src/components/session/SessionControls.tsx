...
import { Play, Square, Trash2, Wifi, WifiOff, Bot, Target, Clock, CheckCircle2, Eye, Camera, CameraOff, Crosshair, ChevronUp, ChevronDown, Gamepad2, Navigation } from 'lucide-react';
            ...
            <div className="flex gap-1.5 overflow-x-auto pb-0.5 -mx-1 px-1 scrollbar-none">
                {visibleModes.map((m) => (
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl text-sm font-semibold whitespace-nowrap transition-all flex-shrink-0 ${
                            mode === m.id
